...
const props = defineProps({
  ...
  showXAxis: { type: Boolean, required: true, default: true },
  showYAxis: { type: Boolean, required: true, default: true },
  showTooltip: { type: Boolean, required: true, default: true },
  showLegend: { type: Boolean, required: true, default: true },
  showGridLine: { type: Boolean, required: true, default: true },
